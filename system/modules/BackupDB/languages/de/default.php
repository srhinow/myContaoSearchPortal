...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_text']    = 'Erstellt eine Website-Konfiguration als WS-Template für das InstallTool';
...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_anl41']   = '   im Pfad /templates/ und /tl_files/ oder Subdirectories (genau';
