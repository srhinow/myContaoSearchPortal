...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_text']    = 'Save the website configuration and create a website-template for InstallTool';
...
$GLOBALS['TL_LANG']['MSC']['tl_backupdb']['ws_template_anl41']   = '   /templates/ and /tl_files/ or subdirectories (just like';
