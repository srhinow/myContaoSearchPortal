...
?>
  ...
  <div style="float:right; padding-right: 4px;">
    <form method="get" class="popup info" id="backup_db" action="<?php echo $GLOBALS['TL_CONFIG']['websitePath'];?>/system/modules/BackupDB/BackupDbRun.php">
  ...
  <div style="float:left; padding-left: 10px;">
    <div style="padding-top: 6px; text-align:left;">
      <?php echo $this->ws_template_text."<br />&nbsp;<br />".$this->ws_template_files."<br />".$this->ws_template_sqlfile."<br />".$this->ws_template_txtfile; ?>
    </div>
  </div>
  <div style="float:right; padding-right: 4px;">
    <form method="get" class="popup info" id="backup_db" action="<?php echo $GLOBALS['TL_CONFIG']['websitePath'];?>/system/modules/BackupDB/MakeWsTemplateRun.php">
      <div class="tl_formbody">
