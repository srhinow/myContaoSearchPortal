...
// kampagnen_layer is MIT-Licensed
	...
	initialize: function(options){
	    ...
	    this.linkClassName = this.options.linkClassName;
	    ...
	    window.addEvent('resize', function(){		 		 
		    ...
		    //your logic goes here
 		    this.parentsize = $(this.parentID).getSize();
	    ...
	    //alle Links mit class="" mit Click-Event ausstatten
	    if(this.linkClassName){
		var links = $$("a").filter(function(el) {
		    return el.hasClass(this.linkClassName);
		});
...
// 		console.log(this.layerID);
		...
		var ifr = new Element('iframe',{
		    ...
		    if($(this.mlIframe)) $(this.mlIframe).destroy();
