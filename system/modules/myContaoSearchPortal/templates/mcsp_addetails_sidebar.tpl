...
<div class="<?php echo $this->class; ?> block"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
    ...
    <a class="questbutton">Nachricht schreiben</a>
    <form action="<?php echo $this->action; ?>" id="ad_contact_form" method="post" class="contactform">
	<input type="hidden" name="FORM_SUBMIT" value="ad_contact_form" />
	<?php if($this->inputEmail->hasErrors()): ?><p><?php echo $this->inputEmail->getErrorAsString();?></p><?php endif; ?>
	<?php echo $this->inputEmail->generateLabel();?>
	<?php echo $this->inputEmail->generate();?>
	<?php if($this->inputNotice->hasErrors()): ?><p><?php echo $this->inputNotice->getErrorAsString();?></p><?php endif; ?>
	<?php echo $this->inputNotice->generateLabel();?>
	<?php echo $this->inputNotice->generate();?> 
	<?php if($this->inputCaptcha->hasErrors()): ?><p><?php echo $this->inputCaptcha->getErrorAsString();?></p><?php endif; ?>
