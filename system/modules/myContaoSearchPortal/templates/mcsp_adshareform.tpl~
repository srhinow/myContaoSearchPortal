...
<div class="<?php echo $this->class; ?> block"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
	...
	<?php echo $this->inputFromEmail->generateLabel();?>
	<?php if($this->inputFromEmail->hasErrors()): ?><p class="error"><?php echo $this->inputFromEmail->getErrorAsString();?></p><?php endif; ?>
	<?php echo $this->inputFromEmail->generate();?>
		
	<?php echo $this->inputToEmail->generateLabel();?>
	<?php if($this->inputToEmail->hasErrors()): ?><p class="error"><?php echo $this->inputToEmail->getErrorAsString();?></p><?php endif; ?>
	<?php echo $this->inputToEmail->generate();?>  
