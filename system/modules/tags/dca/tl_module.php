...
$GLOBALS['TL_DCA']['tl_module']['palettes']['newsarchive']  = str_replace('perPage', 'perPage,tag_filter;{showtags_legend},tag_ignore,news_showtags', $GLOBALS['TL_DCA']['tl_module']['palettes']['newsarchive']);
$GLOBALS['TL_DCA']['tl_module']['palettes']['newslist']  = str_replace('perPage', 'perPage,tag_filter;{showtags_legend},tag_ignore,news_showtags', $GLOBALS['TL_DCA']['tl_module']['palettes']['newslist']);
$GLOBALS['TL_DCA']['tl_module']['palettes']['eventlist']  = str_replace('perPage', 'perPage,tag_filter;{showtags_legend},tag_ignore', $GLOBALS['TL_DCA']['tl_module']['palettes']['eventlist']);
